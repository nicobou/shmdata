...
ShmdataLogger shmdata_make_logger(void (*on_error)(void* user_data, const char*),
                                  ...
                                  void (*on_debug)(void* user_data, const char*),
                                  void* user_data) {
  return static_cast<void*>(new shmdata::CLogger(
      on_error, on_critical, on_warning, on_message, on_info, on_debug, user_data));
}

void shmdata_delete_logger(ShmdataLogger logger) { delete static_cast<shmdata::CLogger*>(logger); }
