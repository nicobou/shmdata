 ...
 */
#ifndef __SWITCHER_TRANSPORT_ADAPTER_SAMPLE_H__
#define __SWITCHER_TRANSPORT_ADAPTER_SAMPLE_H__
 ...
 */
PJ_DECL(pj_status_t) pjmedia_switcher_adapter_create( pjmedia_endpt *endpt,
						      const char *name,
