...
namespace switcher
{
  ...
  H264::init ()
  {
    ...
    register_property (G_OBJECT (h264enc_),"speed-preset","speed-preset", "Speed Preset", true, true);
    register_property (G_OBJECT (h264enc_),"interlaced","interlaced", "Optimize For Interlaced Video", true, true);
    register_property (G_OBJECT (h264enc_),"bitrate","bitrate", "Bitrate (kbps)", true, true);
