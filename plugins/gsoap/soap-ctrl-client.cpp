...
bool SoapCtrlClient::init() {
  ...
  pmanage<MPtr(&PContainer::make_string)>(
      "url", nullptr, [this]() { return url_; }, "Remote server URL", "Remote server URL", url_);
  install_method("Set Remote Switcher",
                 "set_remote_url",
                 "set remote url to control (for instance http://localhost:8080)",
                 "success or fail",
                 Method::make_arg_description("URL", "url", "SOAP url", nullptr),
  ...
  install_method("Set Remote Switcher URL And Retry Until Success",
                 ...
                 "connect remote url to control until success, each try being notified "
                 "with the on_connection_tried",
  ...
  install_method("Remove",
                 ...
                 Method::make_arg_description(
                     "Quiddity Name", "quiddity_name", "name of quiddity to remove", nullptr),
  ...
  install_method(
      ...
      G_TYPE_BOOLEAN,
      Method::make_arg_type_description(
          G_TYPE_STRING, G_TYPE_STRING, G_TYPE_STRING, G_TYPE_STRING, G_TYPE_STRING, nullptr),
      this);
...
SoapCtrlClient::~SoapCtrlClient() {
  reset_endpoint();
  if (switcher_control_ != nullptr) delete switcher_control_;
}
...
gboolean SoapCtrlClient::set_remote_url_retry(gpointer url, gpointer user_data) {
  SoapCtrlClient* context = static_cast<SoapCtrlClient*>(user_data);
  context->reset_endpoint();
  context->url_ = std::string((const char*)url);
  context->switcher_control_->soap_endpoint = context->url_.c_str();
...
gboolean SoapCtrlClient::try_connect(gpointer user_data) {
  ...
  if (context->switcher_control_->error) {
    g_debug("SoapCtrlClient::try_connect (%s) failed, will retry", context->url_.c_str());
...
gboolean SoapCtrlClient::create(gpointer class_name, gpointer quiddity_name, gpointer user_data) {
  SoapCtrlClient* context = static_cast<SoapCtrlClient*>(user_data);
  std::string name;
  context->switcher_control_->create_named_quiddity(
      (const char*)class_name, (const char*)quiddity_name, &name);
  if (g_strcmp0((gchar*)quiddity_name, name.c_str()) != 0) {
    if (!name.empty()) context->switcher_control_->delete_quiddity(name.c_str());
    return FALSE;
  }
  return TRUE;
}
...
gboolean SoapCtrlClient::remove(gpointer quiddity_name, gpointer user_data) {
  ...
  if (context->switcher_control_->error) return FALSE;
  return TRUE;
}

gboolean SoapCtrlClient::set_property(gpointer quiddity_name,
                                      gpointer property_name,
                                      gpointer value,
                                      gpointer user_data) {
  SoapCtrlClient* context = static_cast<SoapCtrlClient*>(user_data);
  context->switcher_control_->send_set_property(
      (gchar*)quiddity_name, (gchar*)property_name, (gchar*)value);
...
gboolean SoapCtrlClient::invoke1(gpointer quiddity_name,
  ...
  std::string result;
  context->switcher_control_->invoke_method(
      (gchar*)quiddity_name, (gchar*)method_name, args, &result);
  return TRUE;
}

gboolean SoapCtrlClient::invoke2(gpointer quiddity_name,
                                 gpointer method_name,
                                 gpointer arg1,
                                 gpointer arg2,
                                 gpointer user_data) {
...
gboolean SoapCtrlClient::invoke3(gpointer quiddity_name,
                                 gpointer method_name,
                                 gpointer arg1,
                                 gpointer arg2,
                                 gpointer arg3,
...
gboolean SoapCtrlClient::invoke4(gpointer quiddity_name,
                                 gpointer method_name,
                                 gpointer arg1,
                                 gpointer arg2,
                                 gpointer arg3,
