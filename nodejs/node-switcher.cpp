...
v8::Handle < v8::Value > SaveHistory (const v8::Arguments & args)
{
  ...
  if (!args[0]->IsString ())
    {
      ThrowException (v8::Exception::
		      TypeError (v8::String::New ("Wrong arguments")));
      return scope.Close (v8::Undefined ());
    }
  v8::String::Utf8Value file_path (args[0]->ToString ());

  if (switcher_container[0]->
      save_command_history (std::string (*file_path).c_str ()))
    {
...
LoadHistoryFromCurrentState (const v8::Arguments & args)
{
  ...
  switcher::QuiddityManager::CommandHistory histo =
    switcher_container[0]->
    get_command_history_from_file (std::string (*file_path).c_str ());
...
v8::Handle < v8::Value > Create (const v8::Arguments & args)
{
  ...
  if (args.Length () == 2)
	...
	v8::String::New (switcher_container[0]->
			 create (std::string (*first_arg),
				 std::string (*second_arg)).c_str ());
    }
  else
    name =
      v8::String::New (switcher_container[0]->
		       create (std::string (*first_arg)).c_str ());
...
v8::Handle < v8::Value > GetClassDoc (const v8::Arguments & args)
{
  ...
  v8::Handle < v8::String > res =
    v8::String::New (switcher_container[0]->
		     get_class_doc (std::string (*class_name)).c_str ());
  return scope.Close (res);
}
...
v8::Handle < v8::Value > GetQuidditiesDescription (const v8::Arguments & args)
{
  ...
  v8::Handle < v8::String > res =
    v8::String::New (switcher_container[0]->get_quiddities_description ().
		     c_str ());
  return scope.Close (res);
}
...
v8::Handle < v8::Value > SetProperty (const v8::Arguments & args)
{
  ...
  v8::Handle < v8::Boolean > res =
    v8::Boolean::New (switcher_container[0]->
		      set_property (std::string (*element_name),
...
v8::Handle < v8::Value > GetProperty (const v8::Arguments & args)
{
  ...
  v8::Handle < v8::String > res =
    v8::String::New (switcher_container[0]->
		     get_property (std::string (*element_name),
...
v8::Handle < v8::Value > GetPropertiesDescription (const v8::Arguments & args)
{
  ...
  v8::Handle < v8::String > res =
    v8::String::New (switcher_container[0]->
		     get_properties_description (std::string (*element_name)).
		     c_str ());
  return scope.Close (res);
}
...
v8::Handle < v8::Value > GetPropertyDescription (const v8::Arguments & args)
{
  ...
  v8::Handle < v8::String > res =
    v8::String::New (switcher_container[0]->
		     get_property_description (std::string (*element_name),
					       std::string (*property_name)).
		     c_str ());
  return scope.Close (res);
}
...
GetPropertiesDescriptionByClass (const v8::Arguments & args)
{
  ...
  v8::Handle < v8::String > res =
    v8::String::New (switcher_container[0]->
		     get_properties_description_by_class (std::
							  string
							  (*class_name)).
		     c_str ());
  return scope.Close (res);
...
GetPropertyDescriptionByClass (const v8::Arguments & args)
{
  ...
  v8::Handle < v8::String > res =
    v8::String::New (switcher_container[0]->
		     get_property_description_by_class (std::
							string (*class_name),
							std::
							string
							(*property_name)).
...
v8::Handle < v8::Value > Invoke (const v8::Arguments & args)
{
  ...
  if (nullptr != return_value)
    {
      v8::Handle < v8::String > res =
	v8::String::New ((*return_value).c_str ());
      return scope.Close (res);
    }
...
v8::Handle < v8::Value > GetMethodsDescription (const v8::Arguments & args)
{
  ...
  v8::Handle < v8::String > res =
    v8::String::New (switcher_container[0]->
		     get_methods_description (std::string (*element_name)).
		     c_str ());
  return scope.Close (res);
}
...
GetMethodsDescriptionByClass (const v8::Arguments & args)
{
  ...
  v8::Handle < v8::String > res =
    v8::String::New (switcher_container[0]->
		     get_methods_description_by_class (std::
						       string (*class_name)).
		     c_str ());
  return scope.Close (res);
}
...
GetMethodDescriptionByClass (const v8::Arguments & args)
{
  ...
  v8::Handle < v8::String > res =
    v8::String::New (switcher_container[0]->
		     get_method_description_by_class (std::
						      string (*class_name),
						      std::
						      string (*method_name)).
		     c_str ());
...
NotifyProp (uv_work_t * r)
{
  ...
  {
  v8::Local <
      v8::Value >::New (v8::String::New (req->quiddity_name.c_str ()))};
  argv[1] =
  {
  v8::Local <
      v8::Value >::New (v8::String::New (req->property_name.c_str ()))};
  argv[2] =
  {
...
v8::Handle < v8::Value > SubscribeToProperty (const v8::Arguments & args)
{
  ...
  v8::Handle < v8::Boolean > res =
    v8::Boolean::New (switcher_container[0]->
		      subscribe_property (std::string ("prop_sub"),
...
v8::Handle < v8::Value > UnsubscribeToProperty (const v8::Arguments & args)
{
  ...
  v8::Handle < v8::Boolean > res =
    v8::Boolean::New (switcher_container[0]->
		      unsubscribe_property (std::string ("prop_sub"),
					    std::string (*element_name),
					    std::string (*property_name)));
  return scope.Close (res);
}
...
v8::Handle < v8::Value > ListSubscribedProperties (const v8::Arguments & args)
{
  ...
  v8::Handle < v8::String > res =
    v8::String::New (switcher_container[0]->
		     list_subscribed_properties_json ("prop_sub").c_str ());
  return scope.Close (res);
}
...
v8::Handle < v8::Value > SubscribeToSignal (const v8::Arguments & args)
{
  ...
  v8::Handle < v8::Boolean > res =
    v8::Boolean::New (switcher_container[0]->
		      subscribe_signal (std::string ("signal_sub"),
					std::string (*element_name),
					std::string (*signal_name)));
  return scope.Close (res);
}
...
v8::Handle < v8::Value > UnsubscribeToSignal (const v8::Arguments & args)
{
  ...
  v8::Handle < v8::Boolean > res =
    v8::Boolean::New (switcher_container[0]->
		      unsubscribe_signal (std::string ("signal_sub"),
					  std::string (*element_name),
					  std::string (*signal_name)));
  return scope.Close (res);
}
...
v8::Handle < v8::Value > ListSubscribedSignals (const v8::Arguments & args)
{
  ...
  v8::Handle < v8::String > res =
    v8::String::New (switcher_container[0]->
		     list_subscribed_signals_json ("signal_sub").c_str ());
  return scope.Close (res);
}
...
v8::Handle < v8::Value > GetSignalsDescription (const v8::Arguments & args)
{
  ...
  v8::Handle < v8::String > res =
    v8::String::New (switcher_container[0]->
		     get_signals_description (std::string (*element_name)).
		     c_str ());
  return scope.Close (res);
}
...
v8::Handle < v8::Value > GetSignalDescription (const v8::Arguments & args)
{
  ...
  v8::Handle < v8::String > res =
    v8::String::New (switcher_container[0]->
		     get_signal_description (std::string (*element_name),
					     std::string (*signal_name)).
		     c_str ());
  return scope.Close (res);
}
...
GetSignalsDescriptionByClass (const v8::Arguments & args)
{
  ...
  v8::Handle < v8::String > res =
    v8::String::New (switcher_container[0]->
		     get_signals_description_by_class (std::
						       string (*class_name)).
		     c_str ());
  return scope.Close (res);
}
...
GetSignalDescriptionByClass (const v8::Arguments & args)
{
  ...
  v8::Handle < v8::String > res =
    v8::String::New (switcher_container[0]->
		     get_signal_description_by_class (std::
						      string (*class_name),
						      std::
						      string (*signal_name)).
		     c_str ());
...
Init (v8::Handle < v8::Object > target)
{
  ...
  gchar *
    ...
    g_strdup_printf ("/usr/local/switcher-0.6/plugins");
  ...
  target->Set (v8::String::NewSymbol ("load_history_from_current_state"),
	       v8::FunctionTemplate::New (LoadHistoryFromCurrentState)->
	       GetFunction ());
  target->Set (v8::String::NewSymbol ("load_history_from_scratch"),
	       v8::FunctionTemplate::New (LoadHistoryFromScratch)->
	       GetFunction ());
  ...
  target->Set (v8::String::NewSymbol ("get_quiddity_description"),
	       v8::FunctionTemplate::New (GetQuiddityDescription)->
	       GetFunction ());
  target->Set (v8::String::NewSymbol ("get_quiddities_description"),
	       v8::FunctionTemplate::New (GetQuidditiesDescription)->
	       GetFunction ());
  ...
  target->Set (v8::String::NewSymbol ("get_properties_description"),
	       v8::FunctionTemplate::New (GetPropertiesDescription)->
	       GetFunction ());
  target->Set (v8::String::NewSymbol ("get_property_description"),
	       v8::FunctionTemplate::New (GetPropertyDescription)->
	       GetFunction ());
  target->Set (v8::String::NewSymbol ("get_properties_description_by_class"),
	       v8::FunctionTemplate::New (GetPropertiesDescriptionByClass)->
	       GetFunction ());
  target->Set (v8::String::NewSymbol ("get_property_description_by_class"),
	       v8::FunctionTemplate::New (GetPropertyDescriptionByClass)->
	       GetFunction ());
  ...
  target->Set (v8::String::NewSymbol ("get_methods_description"),
	       v8::FunctionTemplate::New (GetMethodsDescription)->
	       GetFunction ());
  target->Set (v8::String::NewSymbol ("get_method_description"),
	       v8::FunctionTemplate::New (GetMethodDescription)->
	       GetFunction ());
  target->Set (v8::String::NewSymbol ("get_methods_description_by_class"),
	       v8::FunctionTemplate::New (GetMethodsDescriptionByClass)->
	       GetFunction ());
  target->Set (v8::String::NewSymbol ("get_method_description_by_class"),
	       v8::FunctionTemplate::New (GetMethodDescriptionByClass)->
	       GetFunction ());
  ...
  target->Set (v8::String::NewSymbol ("unsubscribe_to_signal"),
	       v8::FunctionTemplate::New (UnsubscribeToSignal)->
	       GetFunction ());
  target->Set (v8::String::NewSymbol ("list_subscribed_signals"),
	       v8::FunctionTemplate::New (ListSubscribedSignals)->
	       GetFunction ());
}
