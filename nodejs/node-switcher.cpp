  ...
  if (args.Length () == 2)
    {
      ...
      name =
        v8::String::
        New (switcher_container[0]->create
             (std::string (*first_arg), std::string (*second_arg)).c_str ());
    }
  else
    name =
      v8::String::
      New (switcher_container[0]->create (std::string (*first_arg)).c_str ());
...
v8::Handle < v8::Value > GetInfo (const v8::Arguments & args)
{
  ...
  name =
    v8::String::
    New (switcher_container[0]->get_info
         (std::string (*first_arg), std::string (*second_arg)).c_str ());
  return scope.Close (name);
}
...
v8::Handle < v8::Value > GetQuiddityDescription (const v8::Arguments & args)
{
  ...
  v8::Handle < v8::String > res =
    v8::String::
    New (switcher_container[0]->get_quiddity_description
...
v8::Handle < v8::Value > SetProperty (const v8::Arguments & args)
{
  ...
  v8::Handle < v8::Boolean > res =
    v8::Boolean::
    New (switcher_container[0]->set_property
...
v8::Handle < v8::Value > GetProperty (const v8::Arguments & args)
{
  ...
  v8::Handle < v8::String > res =
    v8::String::
    New (switcher_container[0]->get_property
...
v8::Handle < v8::Value > GetPropertiesDescription (const v8::Arguments & args)
{
  ...
  v8::Handle < v8::String > res =
    v8::String::
    New (switcher_container[0]->get_properties_description
...
v8::Handle < v8::Value > GetPropertyDescription (const v8::Arguments & args)
{
  ...
  v8::Handle < v8::String > res =
    v8::String::
    New (switcher_container[0]->get_property_description
         (std::string (*element_name),
          std::string (*property_name)).c_str ());
  return scope.Close (res);
}
...
GetPropertyDescriptionByClass (const v8::Arguments & args)
{
  ...
  v8::Handle < v8::String > res =
    v8::String::
    New (switcher_container[0]->get_property_description_by_class
         (std::string (*class_name), std::string (*property_name)).c_str ());
  return scope.Close (res);
}
...
v8::Handle < v8::Value > GetMethodsDescription (const v8::Arguments & args)
{
  ...
  v8::Handle < v8::String > res =
    v8::String::
    New (switcher_container[0]->get_methods_description
         (std::string (*element_name)).c_str ());
  return scope.Close (res);
}
...
v8::Handle < v8::Value > GetMethodDescription (const v8::Arguments & args)
{
  ...
  v8::Handle < v8::String > res =
    v8::String::
    New (switcher_container[0]->get_method_description
         (std::string (*element_name), std::string (*method_name)).c_str ());
  return scope.Close (res);
}
...
GetMethodsDescriptionByClass (const v8::Arguments & args)
{
  ...
  v8::Handle < v8::String > res =
    v8::String::
    New (switcher_container[0]->get_methods_description_by_class
         (std::string (*class_name)).c_str ());
  return scope.Close (res);
}
...
GetMethodDescriptionByClass (const v8::Arguments & args)
{
  ...
  v8::Handle < v8::String > res =
    v8::String::
    New (switcher_container[0]->get_method_description_by_class
         (std::string (*class_name), std::string (*method_name)).c_str ());
  return scope.Close (res);
}
...
v8::Handle < v8::Value > SubscribeToProperty (const v8::Arguments & args)
{
  ...
  v8::Handle < v8::Boolean > res =
    v8::Boolean::
    New (switcher_container[0]->subscribe_property
...
v8::Handle < v8::Value > UnsubscribeToProperty (const v8::Arguments & args)
{
  ...
  v8::Handle < v8::Boolean > res =
    v8::Boolean::
    New (switcher_container[0]->unsubscribe_property
         (std::string ("prop_sub"), std::string (*element_name),
          std::string (*property_name)));
  return scope.Close (res);
}
...
v8::Handle < v8::Value > SubscribeToSignal (const v8::Arguments & args)
{
  ...
  v8::Handle < v8::Boolean > res =
    v8::Boolean::
    New (switcher_container[0]->subscribe_signal
         (std::string ("signal_sub"), std::string (*element_name),
          std::string (*signal_name)));
  return scope.Close (res);
}
...
v8::Handle < v8::Value > UnsubscribeToSignal (const v8::Arguments & args)
{
  ...
  v8::Handle < v8::Boolean > res =
    v8::Boolean::
    New (switcher_container[0]->unsubscribe_signal
         (std::string ("signal_sub"), std::string (*element_name),
          std::string (*signal_name)));
  return scope.Close (res);
}
...
v8::Handle < v8::Value > GetSignalsDescription (const v8::Arguments & args)
{
  ...
  v8::Handle < v8::String > res =
    v8::String::
    New (switcher_container[0]->get_signals_description
         (std::string (*element_name)).c_str ());
  return scope.Close (res);
}
...
v8::Handle < v8::Value > GetSignalDescription (const v8::Arguments & args)
{
  ...
  v8::Handle < v8::String > res =
    v8::String::
    New (switcher_container[0]->get_signal_description
         (std::string (*element_name), std::string (*signal_name)).c_str ());
  return scope.Close (res);
}
...
GetSignalsDescriptionByClass (const v8::Arguments & args)
{
  ...
  v8::Handle < v8::String > res =
    v8::String::
    New (switcher_container[0]->get_signals_description_by_class
         (std::string (*class_name)).c_str ());
  return scope.Close (res);
}
...
GetSignalDescriptionByClass (const v8::Arguments & args)
{
  ...
  v8::Handle < v8::String > res =
    v8::String::
    New (switcher_container[0]->get_signal_description_by_class
         (std::string (*class_name), std::string (*signal_name)).c_str ());
  return scope.Close (res);
}
...
Init (v8::Handle < v8::Object > target)
{
  ...
  target->Set (v8::String::NewSymbol ("get_method_description"),
               v8::FunctionTemplate::
               New (GetMethodDescription)->GetFunction ());
  ...
  target->Set (v8::String::NewSymbol ("get_signal_description"),
               v8::FunctionTemplate::
               New (GetSignalDescription)->GetFunction ());
  ...
  target->Set (v8::String::NewSymbol ("unsubscribe_to_signal"),
               v8::FunctionTemplate::
               New (UnsubscribeToSignal)->GetFunction ());
