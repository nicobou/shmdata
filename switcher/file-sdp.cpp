...
namespace switcher
{
  ...
  bool FileSDP::init_gpipe ()
  {
    ...
    g_signal_connect (G_OBJECT (sdpdemux_),
		      "pad-added",
		      (GCallback) FileSDP::pad_added_cb, (gpointer) this);
    g_signal_connect (G_OBJECT (sdpdemux_),
		      "no-more-pads",
  ...
  void
    FileSDP::no_more_pads_cb (GstElement * /*object */ ,
			      gpointer /*user_data */ )
  {
  ...
  void
    FileSDP::pad_added_cb (GstElement * /*object */ , GstPad * pad,
			   gpointer user_data)
  {
    FileSDP *context = static_cast < FileSDP * >(user_data);
    ...
    g_sprintf (media_name, "%s_%d", padname_splitted[0],
