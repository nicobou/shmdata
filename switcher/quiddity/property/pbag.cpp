...
bool PBag::replace_impl(prop_id_t prop_id,
...
bool PBag::remove(prop_id_t prop_id) {
  auto it = strids_.find(prop_id);
  if (strids_.end() == it) return false;  // prop not found
...
bool PBag::enable(prop_id_t prop_id) {
...
bool PBag::disable(prop_id_t prop_id, const std::string& why) {
  const auto& it = strids_.find(prop_id);
  if (strids_.end() == it) return false;
  auto key = std::string("property.") + it->second + ".enabled";
...
bool PBag::unsubscribe(prop_id_t id, register_id_t rid) const {
  auto prop = props_.find(id);
  if (prop == props_.end()) return false;
  return prop->second->get()->unsubscribe(std::forward<register_id_t>(rid));
}

property::prop_id_t PBag::get_id(const std::string& strid) const {
  const auto& it = ids_.find(strid);
  if (ids_.end() != it) return it->second;
  // accepting id converted to string
  auto id = id_from_string(strid);
  if (props_.end() != props_.find(id)) return id;
  return 0;
}

std::vector<std::pair<std::string, property::prop_id_t>> PBag::get_ids() const {
  std::vector<std::pair<std::string, property::prop_id_t>> ids;
  for (auto& prop : ids_) {
...
std::string PBag::get_name(prop_id_t id) const {
  const auto& it = strids_.find(id);
  if (strids_.end() != it) return it->second;
  return std::string();
}

std::map<property::prop_id_t, std::string> PBag::get_names() const { return strids_; }

property::prop_id_t PBag::make_int(const std::string& strid,
...
property::prop_id_t PBag::make_parented_int(const std::string& strid,
...
property::prop_id_t PBag::make_short(const std::string& strid,
...
property::prop_id_t PBag::make_parented_short(const std::string& strid,
                                                    const std::string& parent_strid,
                                                    Property<short>::set_cb_t set,
                                                    Property<short>::get_cb_t get,
                                                    const std::string& label,
...
property::prop_id_t PBag::make_long(const std::string& strid,
...
property::prop_id_t PBag::make_parented_long(const std::string& strid,
                                                   const std::string& parent_strid,
                                                   Property<long>::set_cb_t set,
                                                   Property<long>::get_cb_t get,
                                                   const std::string& label,
...
property::prop_id_t PBag::make_long_long(const std::string& strid,
...
property::prop_id_t PBag::make_parented_long_long(const std::string& strid,
                                                        const std::string& parent_strid,
                                                        Property<long long>::set_cb_t set,
                                                        Property<long long>::get_cb_t get,
                                                        const std::string& label,
...
property::prop_id_t PBag::make_unsigned_int(const std::string& strid,
...
property::prop_id_t PBag::make_parented_unsigned_int(const std::string& strid,
                                                           const std::string& parent_strid,
                                                           Property<unsigned int>::set_cb_t set,
                                                           Property<unsigned int>::get_cb_t get,
                                                           const std::string& label,
...
property::prop_id_t PBag::make_unsigned_short(const std::string& strid,
...
property::prop_id_t PBag::make_parented_unsigned_short(const std::string& strid,
                                                             const std::string& parent_strid,
                                                             Property<unsigned short>::set_cb_t set,
                                                             Property<unsigned short>::get_cb_t get,
                                                             const std::string& label,
...
property::prop_id_t PBag::make_unsigned_long(const std::string& strid,
...
property::prop_id_t PBag::make_parented_unsigned_long(const std::string& strid,
                                                            const std::string& parent_strid,
                                                            Property<unsigned long>::set_cb_t set,
                                                            Property<unsigned long>::get_cb_t get,
                                                            const std::string& label,
...
property::prop_id_t PBag::make_unsigned_long_long(const std::string& strid,
...
property::prop_id_t PBag::make_parented_unsigned_long_long(
...
property::prop_id_t PBag::make_bool(const std::string& strid,
...
property::prop_id_t PBag::make_parented_bool(const std::string& strid,
                                                   const std::string& parent_strid,
                                                   Property<bool>::set_cb_t set,
                                                   Property<bool>::get_cb_t get,
                                                   const std::string& label,
...
property::prop_id_t PBag::make_float(const std::string& strid,
...
property::prop_id_t PBag::make_parented_float(const std::string& strid,
                                                    const std::string& parent_strid,
                                                    Property<float>::set_cb_t set,
                                                    Property<float>::get_cb_t get,
                                                    const std::string& label,
...
property::prop_id_t PBag::make_double(const std::string& strid,
...
property::prop_id_t PBag::make_parented_double(const std::string& strid,
                                                     const std::string& parent_strid,
                                                     Property<double>::set_cb_t set,
                                                     Property<double>::get_cb_t get,
                                                     const std::string& label,
...
property::prop_id_t PBag::make_long_double(const std::string& strid,
...
property::prop_id_t PBag::make_parented_long_double(const std::string& strid,
                                                          const std::string& parent_strid,
                                                          Property<long double>::set_cb_t set,
                                                          Property<long double>::get_cb_t get,
                                                          const std::string& label,
...
property::prop_id_t PBag::make_string(const std::string& strid,
...
property::prop_id_t PBag::make_parented_string(const std::string& strid,
                                                     const std::string& parent_strid,
                                                     Property<std::string>::set_cb_t set,
                                                     Property<std::string>::get_cb_t get,
                                                     const std::string& label,
...
property::prop_id_t PBag::make_group(const std::string& strid,
                                           const std::string& label,
                                           const std::string& description) {
  return make_under_parent<Group>(strid, "", label, description);
}

property::prop_id_t PBag::make_parented_group(const std::string& strid,
                                                    const std::string& parent_strid,
                                                    const std::string& label,
                                                    const std::string& description) {
...
property::prop_id_t PBag::make_char(const std::string& strid,
...
property::prop_id_t PBag::make_parented_char(const std::string& strid,
                                                   const std::string& parent_strid,
                                                   Property<char>::set_cb_t set,
                                                   Property<char>::get_cb_t get,
                                                   const std::string& label,
...
property::prop_id_t PBag::make_fraction(const std::string& strid,
...
property::prop_id_t PBag::make_parented_fraction(const std::string& strid,
                                                       const std::string& parent_strid,
                                                       Property<Fraction>::set_cb_t set,
                                                       Property<Fraction>::get_cb_t get,
                                                       const std::string& label,
...
bool PBag::set_str(prop_id_t id, const std::string& val) const {
  if (0 == id) return false;
  auto prop_it = props_.find(id);
  return prop_it->second->get()->set_str(std::forward<const std::string&>(val));
}

std::string PBag::get_str(prop_id_t id) const {
  auto prop_it = props_.find(id);
  return prop_it->second->get()->get_str();
}

bool PBag::set_str_str(const std::string& strid, const std::string& val) const {
  ...
  // accepting id converted to string
  auto prop_id = id_from_string(strid);
  auto prop_it = props_.find(prop_id);
  if (props_.end() == prop_it) return false;
  return prop_it->second->get()->set_str(std::forward<const std::string&>(val));
}

std::string PBag::get_str_str(const std::string& strid) const {
  auto id = get_id(strid);
  if (0 != id) {
    auto prop_it = props_.find(id);
    return prop_it->second->get()->get_str();
...
Any PBag::get_any(prop_id_t id) const { return props_.find(id)->second->get()->get_any(); }

property::prop_id_t PBag::push(const std::string& strid,
                                     std::unique_ptr<PropertyBase>&& prop_ptr) {
  return push_parented(strid, "", std::forward<std::unique_ptr<PropertyBase>>(prop_ptr));
}

property::prop_id_t PBag::push_parented(const std::string& strid,
                                              const std::string& parent_strid,
                                              std::unique_ptr<PropertyBase>&& prop_ptr) {
...
void PBag::init_newly_installed_property(const std::string& strid,
                                               const std::string& parent_strid,
                                               size_t pos) {
  ids_[strid] = counter_;
...
std::unique_lock<std::mutex> PBag::get_lock(prop_id_t id) {
  return props_.find(id)->second->get()->get_lock();
}

void PBag::notify(prop_id_t id) { props_.find(id)->second->get()->notify(); }

void PBag::set_to_current(prop_id_t id) { props_.find(id)->second->get()->set_to_current(); }

void PBag::update_values_in_tree() const {
  for (auto& it : props_) it.second->get()->update_value_in_spec();
}

void PBag::update_value_in_tree(prop_id_t id) const {
  props_.find(id)->second->get()->update_value_in_spec();
}

property::prop_id_t PBag::make_color(const std::string& strid,
...
property::prop_id_t PBag::make_parented_color(const std::string& strid,
                                                    const std::string& parent_strid,
                                                    Property<Color>::set_cb_t set,
                                                    Property<Color>::get_cb_t get,
                                                    const std::string& label,
...
property::prop_id_t PBag::mirror_property_from(const std::string& strid,
                                                     const std::string& parent_strid,
                                                     PBag* pc,
                                                     prop_id_t prop_id) {
