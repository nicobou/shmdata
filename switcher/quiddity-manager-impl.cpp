...
//g_assert (descend != nullptr);
                                        ...
                                        std::string property_value)
  {
    ...
    return (get_quiddity (quiddity_name))->
      set_property (property_name.c_str (), property_value.c_str ());
  }
                                                   ...
                                                   void *user_data)
  {
    ...
    return (get_quiddity (quiddity_name))->
      subscribe_property (property_name.c_str (), cb, user_data);
  }

  bool
    QuiddityManager_Impl::
    unsubscribe_property_glib (std::string quiddity_name,
                               std::string property_name,
                                        ...
                                        std::string property_name)
  {
    ...
    return (get_quiddity (quiddity_name))->
      get_property (property_name.c_str ());
  }
