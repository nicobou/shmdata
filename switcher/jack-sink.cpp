...
namespace switcher
{
  ...
  JackSink::make_elements ()
  {
    ...
    gchar *description = g_strdup_printf ("audioconvert ! audioresample ! jackaudiosink provide-clock=false slave-method=resample max-lateness=100000 client-name=%s sync=false", client_name_);
